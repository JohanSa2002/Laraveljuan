            ...
            <div class="glass-card rounded-[2.5rem] p-10 bg-white">
                <form action="{{ route('admin.events.update', $event) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="name" name="name" type="text" class="mt-1 block w-full rounded-2xl border-gray-200 focus:border-cyber-purple-500 focus:ring-cyber-purple-500" :value="old('name', $event->name)" required />
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4" class="mt-1 block w-full rounded-2xl border-gray-200 focus:border-cyber-purple-500 focus:ring-cyber-purple-500">{{ old('description', $event->description) }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <x-text-input id="start_date" name="start_date" type="date" class="mt-1 block w-full rounded-2xl border-gray-200 focus:border-cyber-purple-500 focus:ring-cyber-purple-500" :value="old('start_date', $event->start_date->format('Y-m-d'))" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="end_date" name="end_date" type="date" class="mt-1 block w-full rounded-2xl border-gray-200 focus:border-cyber-purple-500 focus:ring-cyber-purple-500" :value="old('end_date', $event->end_date->format('Y-m-d'))" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="categories" name="categories" type="text" class="mt-1 block w-full rounded-2xl border-gray-200 focus:border-cyber-purple-500 focus:ring-cyber-purple-500" placeholder="Robótica, Software, Civil, Energía..." :value="old('categories', implode(', ', $event->categories))" required />
                        <x-input-error class="mt-2" :messages="$errors->get('categories')" />
                    </div>

                    <div class="flex items-center gap-2">
                        <input type="checkbox" name="is_active" id="is_active" class="rounded-lg text-cyber-purple-600 focus:ring-cyber-purple-500" {{ $event->is_active ? 'checked' : '' }}>
